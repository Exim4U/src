...
<div id="Forms">
    <table align="center">
        <tr>
            <td colspan="2"><h4><?php echo _("Modify Relay Domain Properties"); ?>:</h4>
                <?php 
    ...
    <tr>
        ...
        <td><input type="text" size="30" name="relay_address" value="<?php print $row['relay_address']; ?>" class="textfield"></td>
    </tr>
