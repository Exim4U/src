    ...
    <form name="domainchange" method="post" action="sitechangesubmit.php">
        <table align="center">
            ...
            <tr>
                ...
                <td><input type="text" size="12" name="outgoing_ip" value="<?php print $row['outgoing_ip']; ?>" class="textfield"></td>
            </tr>
            <?php } ?>
            <tr>
                <td><?php echo _("System UID"); ?>:</td><td><input type="text" size="5" name="uid" value="<?php print $row['uid']; ?>" class="textfield"></td>
            </tr>
            <tr>
                <td><?php echo _("System GID"); ?>:</td><td><input type="text" size="5" name="gid" value="<?php print $row['gid']; ?>" class="textfield"></td>
            </tr>
            <tr>
                <td><?php echo _("Maximum Accounts") . "<br>(" . _("0 for unlimited") . ")"; ?>:</td><td><input type="text" size="5" name="max_accounts" value="<?php print $row['max_accounts']; ?>" class="textfield"></td>
            </tr>
            <tr>
                <td><?php echo _("Max Mailbox Quota") . "<br>(" . _("0 for disabled") . ")"; ?>:</td>
                <td><input type="text" size="5" name="quotas" value="<?php print $row['quotas']; ?>" class="textfield"> MB</td>
            </tr>
            <tr>
            ...
            <tr>
                <td><?php echo _("Enabled"); ?>:</td><td><input type="checkbox" name="enabled" <?php if ($row['enabled'] == 1) {print "checked";} ?>></td>
                <td><input name="domain_id" type="hidden" value="<?php print $_GET['domain_id']; ?>">
                <input name="domain" type="hidden" value="<?php print $_GET['domain']; ?>"></td>
            </tr>
            <tr>
                <td colspan="2" class="button">
