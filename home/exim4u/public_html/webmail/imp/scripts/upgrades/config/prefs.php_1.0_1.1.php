unset($prefGroups['identities']['members']['mail_hdr'],
...
if ($is_pop3) {
    unset($prefGroups['server'],
          ...
          $prefGroups['search'],
          $prefGroups['logintasks']['members']['initialpageselect'],
          $prefGroups['logintasks']['members']['rename_sentmail_monthly'],
          $prefGroups['logintasks']['members']['delete_sentmail_monthly'],
          $prefGroups['logintasks']['members']['delete_sentmail_monthly_keep'],
          $prefGroups['logintasks']['members']['purge_sentmail'],
          $prefGroups['logintasks']['members']['purge_sentmail_interval'],
          $prefGroups['logintasks']['members']['purge_sentmail_keep'],
          $prefGroups['logintasks']['members']['purge_trash'],
          $prefGroups['logintasks']['members']['purge_trash_interval'],
          $prefGroups['logintasks']['members']['purge_trash_keep'],
          $prefGroups['logintasks']['members']['purge_spam'],
          $prefGroups['logintasks']['members']['purge_spam_interval'],
          $prefGroups['logintasks']['members']['purge_spam_keep'],
          $prefGroups['delmove']['members']['use_trash'],
          $prefGroups['delmove']['members']['trashselect'],
          $prefGroups['delmove']['members']['use_vtrash'],
          $prefGroups['delmove']['members']['empty_trash_menu'],
          $prefGroups['display']['members']['nav_expanded'],
          $prefGroups['display']['members']['nav_expanded_sidebar'],
